...
const Signin = () => {
  ...
  const postData = async (e) => {
    ...
    {
      return alert("Only SRMIST institutional email ID's allowed.");
    }
    ...
    if (data.status === 422 || !data) {
      ...
      window.alert("Only SRMIST institutional email ID's allowed");
    } 
      ...
      >
        <div class="form-container sign-up-container">
          <form action="#">
            ...
            <span id="Span">Use your @srmist.edu.in email for registration</span>
            <input
              type="text"
              name="name"
              value={user.name}
        ...
        <div class="form-container sign-in-container">
          <form method="POST" action="#">
            ...
            <span id="Span" className="pb-5">
              Use your @srmist.edu.in account
            </span>
            <input
              type="email"
              value={email_id}
